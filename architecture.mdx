...
<CardGroup cols={2}>
  <Card title="Schemas" icon="sitemap" href="/core/schemas">
    Learn how to define and organize schemas
  </Card>
  <Card title="Types" icon="shapes" href="/core/types">
    Explore all GraphQL type kinds
  </Card>
  <Card title="Fields" icon="list" href="/core/fields">
    Master field definitions and resolvers
  </Card>
  <Card title="Sources" icon="database" href="/advanced/sources">
